...
calculate = () => {
    ...
    switch (funcOption) {
        case 'Meter': if (funcOption2 == "KiloMeter") {
            ...
            break;
        case 'KiloMeter': if (funcOption2 == "Meter") {
            value = funcValue * 1000;
            console.log(value);
        }
        else if (funcOption2 == "CentiMeter") {
            ...
            break;
        case 'CentiMeter': if (funcOption2 == "Meter") {
            value = funcValue / 100;
            console.log(value);
        }
        ...
        case 'Inch': if (funcOption2 == "Meter") {
            ...
            break;
        case 'FarenHeight': if (funcOption2 == "Celcius") {
            value = (funcValue - 32) / 1.8;
            console.log(value);
        }
            break;
        case 'Celcius': if (funcOption2 == "FarenHeight") {
